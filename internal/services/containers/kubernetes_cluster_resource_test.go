...
resource "azurerm_kubernetes_cluster" "test" {
  ...
  `, data.RandomInteger, data.Locations.Primary, controlPlaneVersion)
}
...
resource "azurerm_kubernetes_cluster" "test" {
 ...
 lifecycle {
  ...
  `, data.RandomInteger, data.Locations.Primary, controlPlaneVersion, runCommandEnabled)
}
